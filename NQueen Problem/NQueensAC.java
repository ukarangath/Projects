...
/**
 * NQueens solution using arc-consistency checking
...
public class NQueensAC {
	 ...
	 * locations with value '2'(Constraint location).If another assignment triggers constraint at same location then previous 
	 * value is incremented with 2.
